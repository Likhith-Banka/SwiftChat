    ...
    <div className='h-full w-full relative flex'>
      <div className='flex flex-col w-full'>
        ...
        <div className='flex items-center gap-3 py-3 px-4 border-b border-stone-500'>
          ...
          <img onClick={() => setShowProfile(prev => !prev)} src={assets.help_icon} alt="" className='max-w-5 cursor-pointer' />
        </div>
        ...
        {/* Input */}
        <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-[#00000020]'>
          <div className='flex-1 flex items-center bg-[#1e1e1e] px-3 rounded-full'>
            ...
            <label htmlFor="image" className="p-2 cursor-pointer rounded-full hover:bg-[#333]">
      ...
      <RightSidebar isVisible={showProfile} onClose={() => setShowProfile(false)} />
    </div>
  ) : (
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 w-full h-full max-md:hidden'>
